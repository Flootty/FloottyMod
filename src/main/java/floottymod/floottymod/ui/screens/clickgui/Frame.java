...
public class Frame {
	...
	public void render(MatrixStack matricies, int mouseX, int mouseY, float delta) {
		...
		mc.textRenderer.draw(matricies, category.name, x + 5, y + height / 2 - mc.textRenderer.fontHeight / 2, -1);
		mc.textRenderer.draw(matricies, collapsed ? "+" : "-", x + width - 5 - mc.textRenderer.getWidth("+"), y + height / 2 - mc.textRenderer.fontHeight / 2, -1);
